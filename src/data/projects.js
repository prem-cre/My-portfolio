...
export const allProjects = [
    ...
    {
        title: "Swaply - Advanced Coupon Exchange & Verification Platform",
        description:
            "Swaply is a high-performance, secure coupon and voucher trading platform. It orchestrates a robust Django REST backend and a modernized, ultra-responsive Next.js frontend, integrating secure Neon Auth, dynamic token management, and cryptographic JWKS verification to guarantee double-spend prevention and absolute trade integrity.",
        techStack: [
            "Django (DRF)",
