    ...
    const experiences = [
        {
            ...
            responsibilities: [
                ...
                "Developed a reference-manager-driven citation architecture with summary embeddings, weighted keyword ranking, and auto-generated citation blocks, lowering retrieval latency by 55%.",
                "Designed a real-time gap analysis engine that identifies missing arguments, supporting principles, and counter-reasoning using hybrid RAG + rule-based logic, boosting document completeness by 40%.",
                "Integrated LLM observability modules to log prompt-output lineage, ensure auditability, and support compliance teams in reviewing AI-generated drafts.",
                "Enhanced legal drafting UX with context-aware suggestion generation (research-grounded vs. context-only modes), achieving 2.3× faster drafting throughput for end-users."
            ]
        },
        {
            ...
            responsibilities: [
                ...
                "Pioneered a next-generation recommendation engine with Graph Neural Networks (GNNs) + Faiss, replacing legacy systems to boost processing speed by 60% and optimize cost efficiency."
            ]
        }
    ];
